...
+ MAYAVERSION:2025 PLATFORM:win64 MetaHuman-DNA-Calibration any .
PYTHONPATH +:=
PYTHONPATH +:= data
PYTHONPATH +:= lib/Maya2025/windows
MAYA_PLUG_IN_PATH +:= lib/Maya2025/windows
+ MAYAVERSION:2025 PLATFORM:linux MetaHuman-DNA-Calibration any .
PYTHONPATH +:=
PYTHONPATH +:= data
PYTHONPATH +:= lib/Maya2025/linux
MAYA_PLUG_IN_PATH +:= lib/Maya2025/linux
+ MAYAVERSION:2026 PLATFORM:win64 MetaHuman-DNA-Calibration any .
PYTHONPATH +:=
PYTHONPATH +:= data
PYTHONPATH +:= lib/Maya2026/windows
MAYA_PLUG_IN_PATH +:= lib/Maya2026/windows
+ MAYAVERSION:2026 PLATFORM:linux MetaHuman-DNA-Calibration any .
PYTHONPATH +:=
PYTHONPATH +:= data
PYTHONPATH +:= lib/Maya2026/linux
MAYA_PLUG_IN_PATH +:= lib/Maya2026/linux
